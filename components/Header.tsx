    ...
    <header className="bg-white shadow-md relative z-10">
      <nav className="max-w-4xl mx-auto p-4 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center space-x-2">
          <img src="/logo.png" alt="Baby Meals Planner" width={50} height={50} className="object-contain" />
          <span className="hidden sm:inline text-xl font-bold text-indigo-600">Baby Meals Planner</span>
        </Link>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg flex flex-col items-center p-4 space-y-4">
          ...
          {session ? (
            ...
            <Link
              ...
              className="w-full text-center py-2 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700"
            >
              Login
            </Link>
          )}
